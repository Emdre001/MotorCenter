    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleColor", x => new { x.VehicleId, x.ColorId });
                    table.ForeignKey(
                        name: "FK_VehicleColor_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleColor_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleYear", x => new { x.VehicleId, x.YearId });
                    table.ForeignKey(
                        name: "FK_VehicleYear_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleYear_Years_YearId",
                        column: x => x.YearId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleColor_ColorId",
                table: "VehicleColor",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleYear_YearId",
                table: "VehicleYear",
                column: "YearId");
        }
